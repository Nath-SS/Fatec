...
public class ServletAluno extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * String nome = request.getParameter("txtNome"); String RA =
		 * request.getParameter("txtRa"); String cmd = request.getParameter("cmd");
		 * 
		 * System.out.println("Comando...."+cmd); System.out.println("RA...."+RA);
